...
- [19. Documentacion Externa](#19-documentacion-externa)
...
Usa `Mediator.Send` para dispatch normal. Usa `Spider.Send` cuando el request debe pasar explicitamente por boundaries de Spider.
