namespace TurtlePath.Commands
{
    ...
    /// </summary>
    public abstract class GenericUpdateNoReturnCommandHandler<TRequest, TEntity, TKey> : NoReturnCommandHandler<TRequest>
        ...
        where TEntity : class, IEntity<TKey>
    {
        ...
        protected GenericUpdateNoReturnCommandHandler(IServiceProvider serviceProvider)
        {
