namespace TurtlePath.Commands
{
    ...
    /// </summary>
    public abstract class GenericDeleteNoReturnCommandHandler<TRequest, TEntity, TKey> : NoReturnCommandHandler<TRequest>
        ...
        where TEntity : class, IEntity<TKey>
    {
        ...
        protected GenericDeleteNoReturnCommandHandler(IServiceProvider serviceProvider)
        {
