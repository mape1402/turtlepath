namespace TurtlePath.Commands
{
    ...
    public abstract class BaseEntityDeleteCommandHandler<TRequest, TResponse, TEntity> : EntityDeleteCommandHandler<TRequest, TResponse, TEntity, CId>
        ...
        where TEntity : BaseEntity
    {
        ...
        protected BaseEntityDeleteCommandHandler(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }
    }
}
