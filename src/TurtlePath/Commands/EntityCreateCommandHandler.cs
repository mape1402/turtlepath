namespace TurtlePath.Commands
{
    ...
    public abstract class EntityCreateCommandHandler<TRequest, TResponse, TEntity, TKey> : BaseCommandHandler<TRequest, TResponse>
        ...
        where TResponse : class, IBaseResponse<TKey>
    {
        ...
        protected EntityCreateCommandHandler(IServiceProvider serviceProvider)
        {
