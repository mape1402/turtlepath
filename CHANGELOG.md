...
- Expanded the basic sample into a layered commerce example with command handlers, SQLite-backed EF Core configuration, CId defaults, per-entity profiles, composite identifiers, and hooks.
