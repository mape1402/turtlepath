...
public sealed class TemplateCompositionTests
{
    ...
    public void AddDefaults_registers_template_infrastructure()
    {
        ...
        var outboxDiagnostics = scopedProvider.GetService<IOutboxDiagnostics>();
    ...
    private static IConfiguration CreateConfiguration()
    {
        ...
        {
            ["ConnectionStrings:Default"] = "Server=(localdb)\\mssqllocaldb;Database=Heroes.Service_Composition;Trusted_Connection=True;MultipleActiveResultSets=true",
